 ...
 */
class ProjectPollQuestion extends \App\Entity\ProjectPollQuestion implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'question', 'poll', 'answers');
    }
