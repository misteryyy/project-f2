 ...
 */
class Slideshow extends \App\Entity\Slideshow implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setProject($slot, $project);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'project1', 'project2', 'project3', 'project4', 'project5');
    }
